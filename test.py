...
def test(epoch):
    ...
    with torch.no_grad():
        for iteration, batch in enumerate(testing_data_loader, 1):
            ...
            if int(name[0][23:-4])<=200 and int(name[0][23:-4])>=0:
...
test_set = get_test_set('QB_testdata/ms_label', 'QB_testdata/pan_label',
                        'QB_testdata/ms', 'QB_testdata/pan')
