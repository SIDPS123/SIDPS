...
from MTF_DG import downgrade_images
...
train_set = get_training_set('/data2/gmq/pansharpening/MKD/data/Dataset/QB/TrainFolder/ms_label',
                             '/data2/gmq/pansharpening/MKD/data/Dataset/QB/TrainFolder/pan_label',
                             '/data2/gmq/pansharpening/MKD/data/Dataset/QB/TrainFolder/ms',
                             '/data2/gmq/pansharpening/MKD/data/Dataset/QB/TrainFolder/pan')
training_data_loader = DataLoader(dataset=train_set, num_workers=opt.threads, batch_size=opt.batchSize2, shuffle=True)
test_set = get_test_set('/data2/gmq/pansharpening/MKD/data/Dataset/QB/TestFolder/ms_label', '/data2/gmq/pansharpening/MKD/data/Dataset/QB/TestFolder/pan_label',
                        '/data2/gmq/pansharpening/MKD/data/Dataset/QB/TestFolder/ms', '/data2/gmq/pansharpening/MKD/data/Dataset/QB/TestFolder/pan')
